...
require github.com/uvalib/easystore/uvaeasystore v0.0.0-20260622152012-0d38945481a6
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatchevents v1.33.7 // indirect
