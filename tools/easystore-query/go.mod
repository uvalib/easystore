module github.com/uvalib/easystore-query

go 1.21.7

require github.com/uvalib/easystore/uvaeasystore v0.0.0-20240305190417-f097e0ccab6b
...
require (
	...
	github.com/uvalib/librabus-sdk/uvalibrabus v0.0.0-20240305113541-51af4010b10f // indirect
